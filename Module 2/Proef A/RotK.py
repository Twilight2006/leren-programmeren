...
print('Gewoon een normale nacht als altijd, voor ' + name +'.')
print('De sterren schijnen, de krekels tjirpen, Je kat ligt in haar mand,')
print('En jij ligt wakker, op je telefoon.')
print('Dat is niets nieuws voor ' + name + '.')
...
if antwoord == 'a':
    ...
    print('Waar ben ik?')
    print('Ben ik geontvoerd? is dit een droom?')
    print('Je slaat jezelf.')
    print('wacht, wat was dat? ')
